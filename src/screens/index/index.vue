...
<script>
import { AeButton, AeLabel, AeModal } from "@aeternity/aepp-components";
import isotope from 'vueisotope'
import ContractState from "../../util/contract_state"

export default {
  components: {AeButton, AeLabel, AeModal, isotope},
  data() {
    return {
     list: [{title: "æternity", id: 3, size: "item-small"},
