  ...
  <div class="index-screen screen">
    ...
    <div class="aepps">
      <isotope
        ...
        :options="option"
      >
        <div v-for="element in list" :key="element.id" :class="element.size">
          <div class="inner" @click="expand($event)">
            <svg
              width="207"
              height="34.5"
              viewBox="0 0 138 23"
...
export default {
  ...
  data() {
    return {
      list: [
        { title: "æternity", id: 3, size: "item-small" },
        { title: "æternity", id: 2, size: "item-medium" },
        { title: "æternity", id: 1, size: "item-big" }
      ],
      option: {
        getSortData: {
          id: "id"
