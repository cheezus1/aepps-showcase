<template>
  <div class="fields">
    ...
    <ae-input label="Description" class="field" v-model="description"></ae-input>
    <ae-input label="Contract address" placeholder="ct_" class="field" v-model="address" aeddress></ae-input>
    ...
    <ae-button fill="secondary" face="round" class="submit-button" v-on:click="submit">submit</ae-button>
  </div>
</template>
